...
VERIFICATION_BOT_TOKEN = os.getenv('VERIFICATION_BOT_TOKEN', '7709908636:AAHB9bH74-w565IApIggZ7L1XwdOufXSnu0')  # Токен для бота верификации
VERIFICATION_BOT_ADMIN_ID = os.getenv('VERIFICATION_BOT_ADMIN_ID', '6499246016')  # ID администратора для бота верификации
